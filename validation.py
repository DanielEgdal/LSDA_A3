"""
Utilities for validating user inputs such as metric names and parameter names. Modified from Sklearn!!
"""
import numbers
import posixpath
import re
...
MAX_EXPERIMENT_TAG_KEY_LENGTH = 500
MAX_EXPERIMENT_TAG_VAL_LENGTH = 5000
MAX_ENTITY_KEY_LENGTH = 500
MAX_MODEL_REGISTRY_TAG_KEY_LENGTH = 500
